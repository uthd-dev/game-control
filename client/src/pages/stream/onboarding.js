    ...
    <Layout>
      <ContentWrapper>
        ...
        <OnboardingWrapper>
          ...
          <PageExcerpt>Your onboarding process has begun!</PageExcerpt>
          <br />
          <PageExcerpt>
            We'll let you know through your Twitch email once you're approved.
          </PageExcerpt>
          <Link href="/play/uthd">
            <a>
              <GoPlayButton>
                <ButtonText>Go Play!</ButtonText>
              </GoPlayButton>
            </a>
          </Link>
        </OnboardingWrapper>
