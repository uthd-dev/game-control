...
function Stream() {
  ...
  async function handleSubmit(event) {
    ...
    await setTimeout(async () => {
      if (formData.fname && formData.ign) {
        //POST DATA
        await axios
          .post(`/api/users/streamer-signup`, formData)
          .then((res) => {
            console.log(res);
            ...
            if (res.data.success == true) {
              ...
              successText.classList.remove("hidden");
              if (!errText.classList.contains("hidden"))
                errText.classList.add("hidden");
  ...
  /* Form Update Handlers */ function handleNameChange(event) {
    setFormData({
    ...
    <Layout>
      <ContentWrapper>
        ...
        <SignUpWrapper>
          ...
          <PageExceprt>
            Sign Up now to let viewers take control of your game!
          </PageExceprt>
          <Form onSubmit={handleSubmit}>
            ...
            <ResponseErr id="signup-err" className="hidden">
              Error!
            </ResponseErr>
            <ResponseSuccess id="signup-success" className="hidden">
              Success!
            </ResponseSuccess>
          </Form>
        </SignUpWrapper>
