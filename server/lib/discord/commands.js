...
module.exports = (client) => {
    client.on('message', msg => {
        ...
        if(command == "play") {
            ...
            msg.channel.send(defaultEmbed
                ...
                .addFields(
                    { name: 'Server Addresses: ', value: '**Java:** mc.uthd.dev \n **Bedrock:** mcbe.uthd.dev', inline: true},
                    { name: 'Version ', value: '1.9 - 1.16.5 \n Latest', inline: true},
                    { name: 'Games: ', value: 'PvE/PvP Lobby \n Self-Serve MC Manhunt \n Scuffed BedWars \n Suggestions? #uthd-input'},
    ...
    const defaultEmbed = new Discord.MessageEmbed()
        ...
        .setAuthor('Untethered', 'https://static-cdn.jtvnw.net/jtv_user_pictures/76baa258-c9f9-4979-aae4-f1aca776e002-profile_image-300x300.png', 'https://play.uthd.dev')
        .setTimestamp()
